...
/** Task B: `.lsc/models.yaml` preset mapping all 9 lsc-* agents to the cheap E2E subagent model, so `session_start` (src/main.ts's `applyActivePreset`) injects it live into every `task` spawn for the run. */
